...
require_once('bootstrap.php');
		...
		$errmsg_arr = array();
		global $currentPath;
		$url = $currentPath . "editPrecREST.php";
		$fields = array(
		...
		if(isset($_POST['prec']) && $_POST['prec'] != ''){
			$fields['prec'] = urlencode($_POST['prec']);
		}
	...
	//	print_r($_POST);
		...
		if($errNum == 0){
			$errmsg_arr[] = "Precondition Updated Successfully";
			...
			$_SESSION['ERRMSG_ARR'] = $errmsg_arr;
			header("location: editPrecView.php?prec=" . $_POST['prec'] . "&pat=" . $_POST['pat']);
		}
