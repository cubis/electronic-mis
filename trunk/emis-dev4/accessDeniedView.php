...
<body OnLoad="document.login_Form.login.focus();">
	<div id="container">
    	...
    	<div id="contentwrap">
        	<div id="infobox" style="color: red;">
            <h2>Sorry!</h2>
            <p style="font-size: 13px;">You do not currently have access to this resource. Please log in or register.</p>
            </div>
            <div id="registerbox">
            	<h2>Sign Up</h2>
        ...
        <div id="footer">
            ...
            <div class="footerbox" style="float: right; margin-left: 10px;">
                ...
                <p style="font-size: 11px; margin-top: 0px;">#stankontheplank</p></center>
            </div>
        </div>
	</div>
</body>
